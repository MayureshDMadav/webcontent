      ...
      <div className="container">
        <div className="top">
          <div className="location">
            {getData != 0 ? <p>{getData.name}</p> : ""}{" "}
            {getData.sys ? getData.sys.country : ""}
          </div>
          <div className="temp">
        ...
        <div className="bottom">
          <div className="feels">
            {getData.main ? (
              <p className="bold">{getData.main.feels_like} °F</p>
            ) : null}
            <p>Feels Like</p>
          </div>
          <div className="humidity">
            {getData.main ? (
              <p className="bold">{getData.main.humidity} °F</p>
            ) : null}
            <p>Humidity</p>
          </div>
          <div className="wind">
            {getData.wind ? (
              <p className="bold">{getData.wind.speed} MPH</p>
            ) : null}
            <p>Wind Speed</p>
          </div>
        </div>
